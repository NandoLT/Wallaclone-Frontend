    ...
    return (
        ...
        <div className={classes.margin, "login-input"}>
                    <Grid container spacing={1} alignItems="flex-end">
                        ...
                        <Grid item>
                            <TextField required onChange={handleInputChange} name="confirmNewPassword" id="input-with-icon-grid" label="Confirma la nueva contraseña" type="password" value={passwords.confirmNewPassword} />
                        </Grid>
                    </Grid>
        </div>
